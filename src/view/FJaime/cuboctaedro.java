 ...
 * @author JAIMEUNL
 */
public class cuboctaedro extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cuboctaedro.jpg"))); // NOI18N
    ...
    private void btnAreaOctaedroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAreaOctaedroActionPerformed
        ...
        if(Utiles.validate(txt_lado.getText())){
            Float resultado = F_Jaime.ejecutarCuboctaedro(Utiles.transformStringFloat(txt_lado.getText()));
