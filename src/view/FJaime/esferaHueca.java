 ...
 * @author JAIMEUNL
 */
public class esferaHueca extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("AREA ESFERA HUECA ");
        ...
        jLabel1.setText("INGRESE EL RADIO INTERNO : ");
        ...
        jLabel2.setText("INGRESE EL RADIO EXTERNO:");

        jLabel5.setText("RESULTADO:");

        txt_Result.setText("...");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/esferahueca.png"))); // NOI18N
    ...
    private void btnAreaOctaedroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAreaOctaedroActionPerformed
        ...
        if(Utiles.validate(txt_lado.getText()) && Utiles.validate(txt_cara.getText())){
            Float resultado = F_Jaime.ejecutarEsferahueca(Utiles.transformStringFloat(txt_lado.getText()), Utiles.transformStringFloat(txt_cara.getText()));
