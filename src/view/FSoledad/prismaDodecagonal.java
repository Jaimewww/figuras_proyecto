...
public class prismaDodecagonal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(bg, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnVolumenOctaedroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolumenOctaedroActionPerformed
        ...
        if(Utiles.validate(txtlado.getText()) && Utiles.validate(txtaltura.getText())){
            Float resultado = F_Soledad.ejecutarPrismaDodecagonal (Utiles.transformStringFloat(txtlado.getText()),Utiles.transformStringFloat(txtaltura.getText()));
