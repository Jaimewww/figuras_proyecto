 ...
 * @author JAIMEUNL
 */
public class areaRomboide extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtbase.setBackground(new java.awt.Color(255, 204, 153));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ROMBOIDE.png"))); // NOI18N
    ...
    private void btngenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngenerarActionPerformed
        ...
        if(Utiles.validate(txtbase.getText()) && Utiles.validate(txtaltura.getText())){
            Float resulatado = F_Alex.romboide(Utiles.transformStringFloat(txtaltura.getText()), Utiles.transformStringFloat(txtbase.getText()));
