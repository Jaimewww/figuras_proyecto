 ...
 * @author JAIMEUNL
 */
public class prismaRectangular extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("AREA  PRISMA RECTANGULAR");
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cuadrado.jpg"))); // NOI18N
    ...
    private void btnOrtoedro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrtoedro1ActionPerformed
        ...
        if(Utiles.validate(txtlongitud1.getText()) && Utiles.validate(txtancho1.getText())&& Utiles.validate(txtaltura1.getText())){
            Float resultado = F_Soledad.ejecutarPrismaRectangular(Utiles.transformStringFloat(txtlongitud1.getText()),Utiles.transformStringFloat(txtancho1.getText()),Utiles.transformStringFloat(txtaltura1.getText()));
