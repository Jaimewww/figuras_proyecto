 ...
 * @author JAIMEUNL
 */
public class areaParalelogramo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("AREA PARALELOGRAMO");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/parelelogramo.png"))); // NOI18N
    ...
    private void btngenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngenerarActionPerformed
        ...
        if(Utiles.validate(txtbase.getText()) && Utiles.validate(txtaltura.getText())){
            Float resulatado = F_Alex.paralelogramo(Utiles.transformStringFloat(txtaltura.getText()), Utiles.transformStringFloat(txtbase.getText()));
